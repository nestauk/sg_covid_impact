...
<div class=altair s3_path="sector_diversification_options.json" static_path="scotland/png/sector_diversification_options.png" id="fig:div_option">Scottish sector space
</div>
...
<div class=altair s3_path="div_trends.json" static_path="scotland/png/div_trends.png" id="fig:divnat">Evolution of diversification
</div>
...
<div class=altair s3_path="geo_diversification_profiles.json" static_path="scotland/png/geo_diversification_profiles.png" id="fig:localdiv">Geography of diversification and local sector spaces
</div>
...
<div class=altair s3_path="claimant_counts_Scotland.json" static_path="scotland/png/claimant_counts_Scotland.png" id="fig:cl_scot">Scottish sector space
</div>
...
<div class=altair s3_path="correlation_table.json" static_path="scotland/png/correlation_table.png" id="fig:corr_tab">Scottish sector space
</div>
...
<div class=altair s3_path="modelling_results.json" static_path="scotland/png/modelling_results.png" id="fig:regression">Scottish sector space
</div>
...
<div class=altair s3_path="predicted_outputs.json" static_path="scotland/png/predicted_outputs.png" id="fig:predictive">Scottish sector space
</div>
